...
const natudermaProducts = [
  { id: 'nd-exosomes-ha', name: 'EXOSOMES-HA Rejuvenating Serum', subtitle: 'Phyto Exosomes + Hyaluronic + Niacinamide', description: 'Advanced rejuvenating serum with phyto exosomes, hyaluronic acid and niacinamide for radiant, plump skin.', category: 'Serums', image: 'https://placehold.co/400x400/f0fdf4/16a34a?text=EXOSOMES-HA', url: 'https://natuderma.com/', tags: ['Exosomes', 'Hyaluronic', 'Anti-aging'] },
  { id: 'nd-hyaluronic-serum', name: 'Hyaluronic Acid Serum', subtitle: 'Cica & Vitamin C Formula', description: 'Anti-aging hydrating face serum with Cica and Vitamin C for a glowing, youthful complexion.', category: 'Serums', image: 'https://placehold.co/400x400/f0fdf4/16a34a?text=Hyaluronic+Serum', url: 'https://natuderma.com/', tags: ['Hyaluronic', 'Vitamin C', 'Hydration'] },
  { id: 'nd-niacinamide', name: 'Niacinamide + HA Serum', subtitle: 'Rejuvenating & Barrier Repair', description: 'Powerful barrier repair serum combining Niacinamide and Hyaluronic Acid for smoother, even-toned skin.', category: 'Serums', image: 'https://placehold.co/400x400/f0fdf4/16a34a?text=Niacinamide+HA', url: 'https://natuderma.com/', tags: ['Niacinamide', 'Barrier Repair', 'Even Tone'] },
  { id: 'nd-vitamin-c', name: 'Vitamin C Brightening Serum', subtitle: 'Anti-Aging + Hyaluronic Acid', description: 'Brightening face serum that fights signs of aging and illuminates the skin with powerful Vitamin C.', category: 'Serums', image: 'https://placehold.co/400x400/f0fdf4/16a34a?text=Vitamin+C+Serum', url: 'https://natuderma.com/', tags: ['Vitamin C', 'Brightening', 'Anti-aging'] },
  { id: 'nd-txa5', name: 'TXA5 Advanced Brightening Serum', subtitle: 'Tranexamic + Exosomes + Niacinamide', description: 'Next-generation dark spot corrector with tranexamic acid, exosomes and niacinamide for luminous skin.', category: 'Serums', image: 'https://placehold.co/400x400/f0fdf4/16a34a?text=TXA5', url: 'https://natuderma.com/', tags: ['Dark Spots', 'Brightening', 'Exosomes'] },
  { id: 'nd-flash-glow', name: 'FLASH GLOW24 Serum', subtitle: 'Foaming Glass Skin Serum', description: 'Instant glow daily face serum with exosomes, peptides & niacinamide for that glass skin effect.', category: 'Serums', image: 'https://placehold.co/400x400/f0fdf4/16a34a?text=FLASH+GLOW24', url: 'https://natuderma.com/', tags: ['Glass Skin', 'Peptides', 'Instant Glow'] },
  { id: 'nd-wrinkle-defy', name: 'Wrinkle Defy Serum', subtitle: 'Collagen Peptides + Hyaluronic Acid', description: 'Anti-aging serum with collagen peptides and hyaluronic acid to visibly reduce fine lines.', category: 'Serums', image: 'https://placehold.co/400x400/f0fdf4/16a34a?text=Wrinkle+Defy', url: 'https://natuderma.com/', tags: ['Collagen', 'Anti-wrinkle', 'Hyaluronic'] },
  { id: 'nd-retinol-serum', name: 'Oily Skin Clarifying Serum', subtitle: 'Retinol + Lactic Acid + 11 Amino Acids', description: 'Advanced pore refiner with retinol and lactic acid for oily, acne-prone skin clarity.', category: 'Serums', image: 'https://placehold.co/400x400/f0fdf4/16a34a?text=Retinol+Serum', url: 'https://natuderma.com/', tags: ['Retinol', 'Lactic Acid', 'Oily Skin'] },
  { id: 'nd-exosomes-moisturizer', name: 'Exosomes-M Face Moisturizer', subtitle: 'Anti-Aging Cream with Exosomes & Peptides', description: 'Luxurious anti-aging moisturizer powered by exosomes and peptides for firmer, younger-looking skin.', category: 'Moisturizers', image: 'https://placehold.co/400x400/f0fdf4/16a34a?text=Exosomes+Moisturizer', url: 'https://natuderma.com/', tags: ['Exosomes', 'Peptides', 'Anti-aging'] },
  { id: 'nd-vitamin-c-cream', name: 'Radiant Vitamin C Cream', subtitle: 'Luminous Even Tone & Daily Defense', description: 'Daily defense moisturizer that brightens, evens skin tone and protects against environmental stress.', category: 'Moisturizers', image: 'https://placehold.co/400x400/f0fdf4/16a34a?text=Vitamin+C+Cream', url: 'https://natuderma.com/', tags: ['Vitamin C', 'Even Tone', 'Daily SPF'] },
  { id: 'nd-barrier-cream', name: 'Skin Restore Barrier Rescue Cream', subtitle: 'Cica & Phyto-Defense Complex', description: 'Soothing barrier repair cream with Cica complex, perfect for sensitive or post-procedure skin.', category: 'Moisturizers', image: 'https://placehold.co/400x400/f0fdf4/16a34a?text=Barrier+Cream', url: 'https://natuderma.com/', tags: ['Cica', 'Barrier Repair', 'Sensitive'] },
  { id: 'nd-hydra-mask', name: 'Hydra-Cell+ Recovery Mask', subtitle: 'Post-Procedure Peptide & Stem Cell', description: 'Professional-grade hydrating treatment mask with peptides and stem cells for skin recovery.', category: 'Masks', image: 'https://placehold.co/400x400/f0fdf4/16a34a?text=Hydra+Mask', url: 'https://natuderma.com/', tags: ['Peptides', 'Stem Cell', 'Recovery'] },
  { id: 'nd-peel-off', name: 'Peel-Off Jelly Face Mask', subtitle: 'For Sensitive Skin — Box of 4', description: 'Luxurious peel-off jelly mask made in France with natural ingredients. Firming and revitalizing.', category: 'Masks', image: 'https://placehold.co/400x400/f0fdf4/16a34a?text=Peel-Off+Mask', url: 'https://natuderma.com/', tags: ['Peel-Off', 'Made in France', 'Sensitive'] },
  { id: 'nd-sunscreen', name: 'Sunscreen SPF 50', subtitle: 'Ultra-Moisturizing Broad Spectrum', description: 'Water-resistant (80 min) SPF 50 for face and body. Lightweight, ultra-moisturizing protection.', category: 'Sun Care', image: 'https://placehold.co/400x400/f0fdf4/16a34a?text=SPF+50', url: 'https://natuderma.com/', tags: ['SPF 50', 'Broad Spectrum', 'Water Resistant'] },
  { id: 'nd-cleanser-ha', name: 'Hyaluronic Acid Face Wash', subtitle: 'Hydrating Gentle Cleanser + Rosewater', description: 'Gentle hydrating cleanser with rosewater that purifies without stripping the skin barrier.', category: 'Cleansers', image: 'https://placehold.co/400x400/f0fdf4/16a34a?text=HA+Face+Wash', url: 'https://natuderma.com/', tags: ['Hyaluronic', 'Rosewater', 'Gentle'] },
  { id: 'nd-cleanser-sa', name: 'Salicylic Acid Face Wash', subtitle: 'Clarifying + Pore Minimizer', description: 'Deep-cleansing clarifying face wash with salicylic acid for clear pores and balanced skin.', category: 'Cleansers', image: 'https://placehold.co/400x400/f0fdf4/16a34a?text=SA+Face+Wash', url: 'https://natuderma.com/', tags: ['Salicylic Acid', 'Pore Minimizer', 'Clarifying'] },
];
