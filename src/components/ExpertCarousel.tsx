                ...
                <div className="p-1">
                  <Card className="border-luxury-gold/20 shadow-elegant">
                    <CardContent className="flex flex-col items-center justify-center p-8 md:p-12">
                      ...
                      }} src="/lovable-uploads/e66bd35c-43b9-4b10-b720-f7ca6ee89489.png" className="w-full h-[400px] md:h-[550px] object-cover shadow-elegant-hover border-4 border-luxury-gold/30 rounded-2xl border-accent" />
                          </div>
